    ...
    return(
        <footer>
            <section className="container-fluid">
                <div className="row">
                    <div className="align-items-center col-12 col-sm-4 d-flex my-3 justify-content-center justify-content-sm-start">
                        <ul className="list-unstyled ms-sm-5 text-center text-sm-start">
                            {itemList}
                        </ul>
                    </div>

                    <div
                        className={`align-items-center col-12 col-sm-4 d-flex flex-column justify-content-center my-3 ${style.social}`}>
